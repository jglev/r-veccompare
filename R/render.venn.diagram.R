...
#' @param viewport_npc_width_height_to_force The scale at which to print the image. If the image is cut off at its edges, for example, this can be set lower than 1.0.
#'
